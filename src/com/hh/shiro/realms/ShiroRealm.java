...
public class ShiroRealm extends AuthorizingRealm {
	...
	//说白了就是从数据库查出来 然后比对 返回一个info对象
	//认证的方法
	@Override
	protected AuthenticationInfo doGetAuthenticationInfo(
			AuthenticationToken token) throws AuthenticationException {
		System.out.println("让我瞅瞅拿到的token [FirstRealm] doGetAuthenticationInfo ----------->"+token);
		...
		System.out.println("从数据库中获取 username: " + eamil + " 所对应的用户信息.");
